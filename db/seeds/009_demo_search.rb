...
carrot_cake_1.stall_id = Stall.all.sample
...
carrot_cake_2.stall_id = Stall.all.sample
...
carrot_cake_3.stall_id = Stall.all.sample
...
carrot_cake_4.stall_id = Stall.all.sample
...
carrot_cake_5.stall_id = Stall.all.sample
...
carrot_cake_6.stall_id = Stall.all.sample
...
carrot_cake_7.stall_id = Stall.all.sample
...
carrot_cake_8.stall_id = Stall.all.sample
...
carrot_cake_9.stall_id = Stall.all.sample
...
carrot_cake_10.stall_id = Stall.all.sample
carrot_cake_10.photo.attach(
    io: File.open('app/assets/images/seed_demo/carrot_cake_10.jpg'),
    filename: "carrot_cake_10.jpg",
    content_type: "photo/jpg"
  )

User.first(10).each do |user|
  Dish.where(item_type: "Carrot Cake").each do |dish|
    review = Review.new
